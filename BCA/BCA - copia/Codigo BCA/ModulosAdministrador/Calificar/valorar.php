              ...
              <div class="row-fluid">
                    <div class="span4">
                        ...
                        <button class="btn btn dropdown-toggle" data-toggle="dropdown">
                        	<i class="icon-search"></i> <strong>Lapso</strong> <span class="caret"></span>
                        </button>
                    ...
                    <div class="span4" align="center">
                    	<?php
							...
							if(!empty($_GET['periodo'])){
								...
								echo '<strong>Todos los Lapsos</strong>';
							}
						?>
                    </div>
                ...
                <table class="table table-bordered table table-hover">
                  <tr class="info">
                    ...
                    <td width="33%"><center><strong>Lapso</strong></center></td>
                    <td width="15%"><center><strong>N. Valoracion</strong></center></td>
                    <td width="6%">&nbsp;</td>
                  </tr>
                  <?php 
				 	if(!empty($_GET['periodo'])){
                         ...
                         <div id="m<?php echo $row['periodo'].$row['materia']; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-header">
                                ...
                                <h3 id="myModalLabel" align="center">
                                    Materia "<?php echo $oMateria->consultar('nombre'); ?>"<br>Lapso <?php echo $oPeriodo->consultar('nombre'); ?>
                                </h3>
                            </div>
