                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span6">
                                <!--<a href="#nuevo" role="button" class="btn" data-toggle="modal">
                                    <strong><i class="icon-plus"></i> Calificacion</strong>
                                </a>-->
                                <!--<form method="post" class"form">
                                <input type="text" id="id-alumno" name="alumno" placeholder="codigo alumno" style="margin:4px 2px"/>
                                <!--<button class="btn" data-dismiss="modal" aria-hidden="true"><strong><i class="icon-plus"></i> Calificacion</strong></button>-->
                                <!--<a target="_blank" href="javascript:reporteCalificacion();" class="btn " data-dismiss="modal" aria-hidden="true" style="border-color: rgb(6, 26, 6)"><strong><i class="icon-plus"></i> Calificacion</strong></a>
                                </form>-->

                               <form method="post" class"form" action="calificacionExcel.php">
                                <input type="text" id="" name="alumno" placeholder="codigo alumno" style="margin:4px 2px"/>
                                <input type="Submit" name="Calificaciones" class="btn" value="Calificacion">
                               </form>
