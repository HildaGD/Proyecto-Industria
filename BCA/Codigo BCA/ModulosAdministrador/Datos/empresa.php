...
<html lang="es">
  <head>
    <meta charset="utf-8">
    <title>.: Informacion de la Institución :.</title>
      ...
      <tr>
        <td>
        	...
        	<table class="table table-bordered">
              <tr class="info">
                <td><center><h1 class="text-info">Informacion de la Institución</h1></center></td>
              </tr>
            </table>
        ...
        <td>
             ...
             <?php
				if(!empty($_POST['empresa']) and !empty($_POST['nit'])){
					...
					mysql_query($conexion,"UPDATE empresa SET empresa='$empresa',
													pais='$pais',
													ciudad='$ciudad',
													direccion='$direccion',
													correo='$correo',
					...
					echo mensajes('Dato de la Institución Actualizado con Exito','verde');
            ...
            <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <h3 id="myModalLabel">Actualizar Informacion de la Institución</h3>
                </div>
