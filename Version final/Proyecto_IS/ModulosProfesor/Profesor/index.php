...
<html lang="es">
  ...
  <body>
    ...
    <?php include_once "../../menuProfesor/m_profesor.php"; ?>
    <div align="center">
    	<table width="90%">
          <tr>
            <td>
                                    ...
                                    <div class="modal-body">
                						<div class="row-fluid">
                                        	...
                                        	<div class="span6">
                                                ...
                                                <input type="text" name="contrasenia" autocomplete="off" required value=""><br>
                                            </div>
                                        </div>
                                    </div>
            	...
            	<table class="table table-bordered table table-hover">
                  ...
                  <?php
						if(!empty($_POST['buscar'])){
							...
							$pa=mysqli_query($conexion,"SELECT * FROM profesor WHERE nom LIKE '%$buscar%' or ape LIKE '%$buscar%' or doc='$buscar'");					
						}else{
