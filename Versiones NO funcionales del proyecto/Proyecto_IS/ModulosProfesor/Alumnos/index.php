...
<html lang="es">
  ...
  <body>
    ...
    <?php include_once "../../menuProfesor/m_alumnos.php"; ?>
                    	...
                    	<div class="row-fluid">
                        	...
                        	<div class="span6">
                           		<form name="form1" method="post" action="">
                                	...
                                	<input type="text" name="buscar" class="input-xlarge" autocomplete="off" autofocus placeholder="Buscar por Documento o Nombre">
