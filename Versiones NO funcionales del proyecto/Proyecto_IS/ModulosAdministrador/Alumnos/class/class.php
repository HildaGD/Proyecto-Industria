...
//Alumno
            ...
            mysqli_query($conexion, "INSERT INTO alumno (ID_ALUMNO, ID_INFO_MEDICA, NOMBRE, ESCUELA_PROCEDENCIA, UTILIZA_TRANSPORTE, NOTAS, CROQUIS, ACTIVO_ALUMNO, DIRECCION, LUGAR_NACIMIENTO,  FECHA_NACIMIENTO, RELIGION, NO_IDENTIDAD) 
		...
		try{
        	...
        	if (mysqli_num_rows($pa) != "0") {
                ...
                {  		             
		            ...
		            mysqli_query($conexion,"INSERT INTO clasexalumno (ID_CLASE, ID_ALUMNO, ID_SECCION,ID_JORNADA, ID_PERIODO) VALUES ('$ID_CLASE','$ID_ALUMNO','$seccion','$jornada','$periodo')");	           
		          ...
		          while($parcial=mysqli_fetch_array($par))
                {
		            ...
		            mysqli_query($conexion,"INSERT INTO calificaciones ( ID_PARCIAL,  ID_SECCION, ID_ALUMNO, ID_CLASE, HOMEWORK, CLASSWORK, CLASSWORK_EVALUATION, TEST, PUNTAJE, NOTA,  ANIO) 
