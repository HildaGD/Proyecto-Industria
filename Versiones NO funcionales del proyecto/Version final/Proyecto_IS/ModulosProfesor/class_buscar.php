...
class Consultar_Clase{
	...
	function __construct($codigo,$conexion){
		$this->conexion=$conexion;
		$this->consulta = mysqli_query($this->conexion,"SELECT * FROM clase WHERE id_clase='$codigo'");
		$this->fetch = mysqli_fetch_array($this->consulta);
	}
...
class Consultar_Alumno{
	...
	function __construct($conexion,$codigo){
		$this->conexion=$conexion;
		$this->consulta=mysqli_query($this->conexion,"SELECT * FROM alumno WHERE id_alumno='$codigo'");
		$this->fetch=mysqli_fetch_array($this->consulta);
	}
